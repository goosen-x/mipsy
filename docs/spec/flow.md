...
flowchart TD
  ...
  S --> OWN{"Адрес наш или ничей?"}
  OWN -->|"незнакомый или своя сессия"| T["Кабинет /me открыт,<br/>сессия на этом устройстве"]
  OWN -->|"занят чужим аккаунтом"| LOG2["Заявка сохранена,<br/>вход только по коду"]
...
~~Первая встреча бесплатна по правилу платформы~~ **(отменено 14.08: бесплатных сеансов нет, все сессии платные по грейду специалиста).** Переподбор остаётся бесплатным и в один клик.
...
**Кто получает сессию.** Анкета, заявка психолога и бронь заводят аккаунт по введённой почте, но пускают внутрь без кода только владельца: адрес либо незнаком нам (аккаунт создаётся сейчас), либо совпадает с текущей сессией. Иначе — «войдите по коду». Правило вынесено в `mayAdoptSession()` и закрыто тестом: без него чужая почта в анкете отдавала чужой кабинет.
