...
Роль клиента и роль психолога живут на разных аккаунтах: `accounts.role` выбирается первым действием и не меняется, на одной почте два кабинета не заводятся (см. `docs/deploy.md`, «Вход в кабинеты»). Админ — отдельный флаг поверх любой роли.
