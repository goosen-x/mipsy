  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-2xl px-4 py-12">
        ...
        <p className="mt-4 rounded-2xl bg-amber-50 p-4 text-neutral-700">
          Важно: mipsy — платформа психологической поддержки, мы не оказываем медицинскую и
          психиатрическую помощь. Если есть мысли о самоповреждении или состояние быстро
          ухудшается — нужен врач-психиатр: обратитесь в ПНД по месту жительства или вызовите
          скорую по номеру 112. Это обычная медицинская помощь, за ней не следует ни учёта
          «на всю жизнь», ни осуждения.
        </p>
