...
const STEPS = [
  ...
  },
  {
    ...
    text: "Не алгоритм, а живой человек изучит вашу анкету, подберёт специалиста под запрос и позвонит вам.",
  },
  {
    title: "Выберите время",
    text: "Договоритесь о первой встрече. У многих специалистов есть бесплатное знакомство на 20 минут — чтобы понять, ваш ли это человек.",
  },
];
...
const FAQ = [
  ...
  {
    q: "Сколько это стоит?",
    a: "Подбор бесплатный. Стоимость сессии каждый психолог указывает в своём профиле — вы увидите её до того, как согласитесь на встречу.",
  },
  {
  ...
  },
  {
    ...
    a: "Да. Вашу анкету видят только оператор и психолог, с которым вас соединили. Общение идёт через платформу, телефон нужен только для связи с вами.",
  },
];
  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="mx-auto max-w-5xl px-4 py-16">
          <div className="rounded-3xl bg-brand-800 p-10 text-white">
        ...
        <section className="mx-auto max-w-5xl px-4 py-16 text-center">
          ...
          <Button asChild size="lg" className="mt-6 rounded-full px-8 py-6 text-lg">
