...
const FAQ = [
  ...
  },
  {
    ...
    a: "Да. Вашу анкету видят только оператор и психолог, с которым вас соединили. Общение идёт через платформу; телефон мы не спрашиваем, для связи достаточно почты.",
  },
];
