...
const STEPS = [
  ...
  },
  {
    ...
    text: "Выбираете свободное время в календаре и приходите. Стоимость сессии видна заранее в профиле специалиста.",
  },
];
...
const FAQ = [
  ...
  {
    q: "Сколько это стоит?",
    a: "Подбор бесплатный. Сессии платные: стоимость зависит от уровня специалиста, её назначает платформа, и вы видите её до записи — в каталоге и в профиле.",
  },
  {
  ...
  },
  {
    ...
    a: "Психолог помогает разговором: разобраться в себе, отношениях, тяжёлых ситуациях. Психиатр — это врач: он ставит диагнозы и назначает лекарства. Специалисты платформы — психологи, они не оказывают медицинских услуг и не заменяют врача. Если вам тяжело настолько, что трудно жить обычной жизнью, есть мысли о самоповреждении или врач уже рекомендовал лечение — правильный первый шаг это психиатр, а психолог станет хорошей поддержкой рядом с ним.",
  },
];
